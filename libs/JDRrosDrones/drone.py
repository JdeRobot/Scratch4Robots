...
import config
import rospy
from publisherExtra import PublisherExtra
from cmdvel import *
...
class Drone():
    ...
    def __init__(self, cfg):
        ...
        # self.__node = rospy.init_node("drone", anonymous=True)
        ...
        print "[drone class] Publishing drone.Extra with ROS messages"
        self.__extra_client = PublisherExtra(topicarming, topicland, topicSetMode)
        print "[drone class] drone.CMDVel for ROS messages"
        self.__cmdvel_client = PublisherCMDVel(topicvel)
    ...
    def take_off(self):
        ...
        """
        print "[drone class] takeoff"
        self.__extra_client.arming()
        self.__cmdvel_client.sendCMDVel(0,0,2,0,0,0)
        time.sleep(1)
        self.__cmdvel_client.sendCMDVel(0,0,0,0,0,0)
